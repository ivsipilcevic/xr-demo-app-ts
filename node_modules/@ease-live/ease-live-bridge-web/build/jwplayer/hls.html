<!doctype html><html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/><link rel="stylesheet" href="../example.css"><title>JW Player with Ease Live</title><script src="../EaseLive.13bd0dea.js"></script><script src="../BitMovinPlugin.13bd0dea.js"></script><script src="../JwPlayerPlugin.13bd0dea.js"></script><script src="../FlowplayerPlugin.13bd0dea.js"></script><script src="../HlsJSPlugin.13bd0dea.js"></script><script src="../FakeTimePlugin.13bd0dea.js"></script></head><body onload="init()"><script src="jwplayer.js"></script><script src="jw_init.js"></script><script>jwplayer.key="tKRsIZg7TXaSRLnlgpFXsIZCewZNadAvVmPHG5Et624=";</script><style>.xcomponent {
		...
		}</script><div id="source"><h1>JW Player: HLS</h1>Video source: <span id="label"></span></div><div id="logging">Logging output: <span id="output"></span> <span id="error"></span></div><div id="buttonContainer"><h1></h1></div><div id="playerContainerJw"><div id="player"></div></div><div id="buttons"><button id="fullscreen" onclick="fs()">Full screen</button></div><p>To demonstrate events received from the web app (two-way communication), we have added a "Click me" button to the example web app which emits an 'app.click' event (implemented by running `app.bridge.send('app.click');` in the component). Here we are attaching a listener to this event, to count the number of clicks.</p><div id="back"><a href="../index.html">Back to examples</a></div></body></html>